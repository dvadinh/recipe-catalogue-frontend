...
export default function OAuth2AuthenticationPage() {
    ...
    <Box sx={{ pt: 'calc(64px + 32px)', pb: 4, backgroundColor: '#f5f5f7', minHeight: '100vh' }}>
      ...
      <Stack spacing={2}>
        <Card sx={{ border: '1px solid #d2d2d7' }}>
          <CardActionArea onClick={() => navigate('/auth/oauth2/sign-up')}>
            <CardContent>
              <Typography variant="h6">Sign Up</Typography>
              <Typography variant="body2" color="text.secondary">
                Create a new account with OAuth2
              </Typography>
            </CardContent>
          </CardActionArea>
        </Card>
        ...
        <Card sx={{ border: '1px solid #d2d2d7' }}>
          <CardActionArea onClick={() => navigate('/auth/oauth2/sign-in')}>
            <CardContent>
